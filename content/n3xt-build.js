...
gunlocke.TypicalZero = class extends n3xt.Element {
    constructor(model = {
        ...
        this.position.yaw=1.0472;
        this.position.x = -1;
        
    }

    get geometries() {
        var woodColor = this.model.woodFinish == "dark" ? 0xffffff : 0xaa6655;
        // var tableColor = this.model.tableFinish == "dark" ? 0x080808 : 0xaaaaaa;
        var glassColor = 0x111811;
        return [
            ...
            new gunlocke.TypicalZeroGeometry({
                "wood": new n3xt.WoodMaterial(woodColor),
                "glass": new n3xt.PlainMaterial(glassColor, .5),
            })
...
gunlocke.TypicalZeroGeometry = class extends n3xt.StudioGeometry {
    get studioData() {
        return {"url":"3d/mateus.obj","uvScale":1,"layerMap":{"glass":["glass3","glass1","glass2"],"wood":["Rectangle092","Rectangle078","Rectangle079","Rectangle002","Rectangle003","Rectangle016","Rectangle048","Rectangle049","Rectangle004","Rectangle073"]}}
        // return {
